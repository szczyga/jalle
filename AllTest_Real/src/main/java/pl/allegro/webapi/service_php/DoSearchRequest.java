...
public class DoSearchRequest  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.SearchOptType searchQuery;
    ...
    public DoSearchRequest(
           ...
           pl.allegro.webapi.service_php.SearchOptType searchQuery) {
     ...
     * @return searchQuery
     */
    public pl.allegro.webapi.service_php.SearchOptType getSearchQuery() {
        return searchQuery;
    }
     ...
     * @param searchQuery
     */
    public void setSearchQuery(pl.allegro.webapi.service_php.SearchOptType searchQuery) {
        this.searchQuery = searchQuery;
    }
