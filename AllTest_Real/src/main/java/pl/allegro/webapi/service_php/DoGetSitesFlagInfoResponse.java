...
public class DoGetSitesFlagInfoResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.SiteFlagInfoType[] sitesInfoList;
    ...
    public DoGetSitesFlagInfoResponse(
           pl.allegro.webapi.service_php.SiteFlagInfoType[] sitesInfoList,
           long verKey,
     ...
     */
    public pl.allegro.webapi.service_php.SiteFlagInfoType[] getSitesInfoList() {
        return sitesInfoList;
    }
     ...
     * @param sitesInfoList
     */
    public void setSitesInfoList(pl.allegro.webapi.service_php.SiteFlagInfoType[] sitesInfoList) {
        this.sitesInfoList = sitesInfoList;
    }
