...
public class DoGetServiceInfoResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.ServiceInfoStruct[] serviceInfoItemsList;

    public DoGetServiceInfoResponse() {
    }

    public DoGetServiceInfoResponse(
           pl.allegro.webapi.service_php.ServiceInfoStruct[] serviceInfoItemsList) {
     ...
     */
    public pl.allegro.webapi.service_php.ServiceInfoStruct[] getServiceInfoItemsList() {
        return serviceInfoItemsList;
    }
     ...
     */
    public void setServiceInfoItemsList(pl.allegro.webapi.service_php.ServiceInfoStruct[] serviceInfoItemsList) {
        this.serviceInfoItemsList = serviceInfoItemsList;
    }
