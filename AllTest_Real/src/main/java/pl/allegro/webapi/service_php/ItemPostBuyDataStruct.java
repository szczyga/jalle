...
public class ItemPostBuyDataStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.UserPostBuyDataStruct[] usersPostBuyData;
    ...
    public ItemPostBuyDataStruct(
           long itemId,
           pl.allegro.webapi.service_php.UserPostBuyDataStruct[] usersPostBuyData) {
           this.itemId = itemId;
     ...
     */
    public pl.allegro.webapi.service_php.UserPostBuyDataStruct[] getUsersPostBuyData() {
        return usersPostBuyData;
    }
     ...
     */
    public void setUsersPostBuyData(pl.allegro.webapi.service_php.UserPostBuyDataStruct[] usersPostBuyData) {
        this.usersPostBuyData = usersPostBuyData;
    }
