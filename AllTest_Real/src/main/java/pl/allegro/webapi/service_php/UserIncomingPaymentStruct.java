...
public class UserIncomingPaymentStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.PaymentDetailsStruct[] payTransDetails;
    ...
    public UserIncomingPaymentStruct(
           ...
           pl.allegro.webapi.service_php.PaymentDetailsStruct[] payTransDetails,
     ...
     */
    public pl.allegro.webapi.service_php.PaymentDetailsStruct[] getPayTransDetails() {
        return payTransDetails;
    }
     ...
     */
    public void setPayTransDetails(pl.allegro.webapi.service_php.PaymentDetailsStruct[] payTransDetails) {
        this.payTransDetails = payTransDetails;
    }
