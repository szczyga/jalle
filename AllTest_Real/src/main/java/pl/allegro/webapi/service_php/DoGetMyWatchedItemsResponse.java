...
public class DoGetMyWatchedItemsResponse  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.WatchedItemStruct[] watchedItemsList;
    ...
    public DoGetMyWatchedItemsResponse(
           ...
           pl.allegro.webapi.service_php.WatchedItemStruct[] watchedItemsList) {
     ...
     */
    public pl.allegro.webapi.service_php.WatchedItemStruct[] getWatchedItemsList() {
        return watchedItemsList;
    }
     ...
     */
    public void setWatchedItemsList(pl.allegro.webapi.service_php.WatchedItemStruct[] watchedItemsList) {
        this.watchedItemsList = watchedItemsList;
    }
