...
public class DoCheckItemDescriptionResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.ItemDescriptionStruct itemDescription;

    public DoCheckItemDescriptionResponse() {
    }

    public DoCheckItemDescriptionResponse(
           pl.allegro.webapi.service_php.ItemDescriptionStruct itemDescription) {
     ...
     */
    public pl.allegro.webapi.service_php.ItemDescriptionStruct getItemDescription() {
        return itemDescription;
    }
     ...
     */
    public void setItemDescription(pl.allegro.webapi.service_php.ItemDescriptionStruct itemDescription) {
        this.itemDescription = itemDescription;
    }
