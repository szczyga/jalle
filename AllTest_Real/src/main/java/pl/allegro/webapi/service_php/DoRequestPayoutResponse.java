...
public class DoRequestPayoutResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.RequestPayoutStruct requestPayout;

    public DoRequestPayoutResponse() {
    }

    public DoRequestPayoutResponse(
           pl.allegro.webapi.service_php.RequestPayoutStruct requestPayout) {
     ...
     */
    public pl.allegro.webapi.service_php.RequestPayoutStruct getRequestPayout() {
        return requestPayout;
    }
     ...
     * @param requestPayout
     */
    public void setRequestPayout(pl.allegro.webapi.service_php.RequestPayoutStruct requestPayout) {
        this.requestPayout = requestPayout;
    }
