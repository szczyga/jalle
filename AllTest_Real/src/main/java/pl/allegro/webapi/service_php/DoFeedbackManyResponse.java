...
public class DoFeedbackManyResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.FeedbackResultStruct[] feResults;

    public DoFeedbackManyResponse() {
    }

    public DoFeedbackManyResponse(
           pl.allegro.webapi.service_php.FeedbackResultStruct[] feResults) {
     ...
     * @return feResults
     */
    public pl.allegro.webapi.service_php.FeedbackResultStruct[] getFeResults() {
        return feResults;
    }
     ...
     * @param feResults
     */
    public void setFeResults(pl.allegro.webapi.service_php.FeedbackResultStruct[] feResults) {
        this.feResults = feResults;
    }
