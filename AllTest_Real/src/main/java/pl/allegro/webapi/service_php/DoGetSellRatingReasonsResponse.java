...
public class DoGetSellRatingReasonsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.SellRatingInfoStruct[] sellRatingInfo;

    public DoGetSellRatingReasonsResponse() {
    }

    public DoGetSellRatingReasonsResponse(
           pl.allegro.webapi.service_php.SellRatingInfoStruct[] sellRatingInfo) {
     ...
     */
    public pl.allegro.webapi.service_php.SellRatingInfoStruct[] getSellRatingInfo() {
        return sellRatingInfo;
    }
     ...
     */
    public void setSellRatingInfo(pl.allegro.webapi.service_php.SellRatingInfoStruct[] sellRatingInfo) {
        this.sellRatingInfo = sellRatingInfo;
    }
