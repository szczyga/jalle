...
public class DoGetPostBuyFormsDataForSellersResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.PostBuyFormDataStruct[] postBuyFormData;

    public DoGetPostBuyFormsDataForSellersResponse() {
    }

    public DoGetPostBuyFormsDataForSellersResponse(
           pl.allegro.webapi.service_php.PostBuyFormDataStruct[] postBuyFormData) {
     ...
     */
    public pl.allegro.webapi.service_php.PostBuyFormDataStruct[] getPostBuyFormData() {
        return postBuyFormData;
    }
     ...
     */
    public void setPostBuyFormData(pl.allegro.webapi.service_php.PostBuyFormDataStruct[] postBuyFormData) {
        this.postBuyFormData = postBuyFormData;
    }
