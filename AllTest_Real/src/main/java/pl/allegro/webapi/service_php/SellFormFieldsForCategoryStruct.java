...
public class SellFormFieldsForCategoryStruct  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.SellFormType[] sellFormFieldsList;
    ...
    public SellFormFieldsForCategoryStruct(
           pl.allegro.webapi.service_php.SellFormType[] sellFormFieldsList,
     ...
     */
    public pl.allegro.webapi.service_php.SellFormType[] getSellFormFieldsList() {
        return sellFormFieldsList;
    }
     ...
     */
    public void setSellFormFieldsList(pl.allegro.webapi.service_php.SellFormType[] sellFormFieldsList) {
        this.sellFormFieldsList = sellFormFieldsList;
    }
