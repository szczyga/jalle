...
public class DoGetMessageToBuyerResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.MessageToBuyerStruct messageToBuyer;

    public DoGetMessageToBuyerResponse() {
    }

    public DoGetMessageToBuyerResponse(
           pl.allegro.webapi.service_php.MessageToBuyerStruct messageToBuyer) {
     ...
     */
    public pl.allegro.webapi.service_php.MessageToBuyerStruct getMessageToBuyer() {
        return messageToBuyer;
    }
     ...
     */
    public void setMessageToBuyer(pl.allegro.webapi.service_php.MessageToBuyerStruct messageToBuyer) {
        this.messageToBuyer = messageToBuyer;
    }
