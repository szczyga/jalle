...
public class FiltersListType  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.FilterValueType[] filterValues;

    private pl.allegro.webapi.service_php.FilterRelationType filterRelations;
    ...
    public FiltersListType(
           ...
           pl.allegro.webapi.service_php.FilterValueType[] filterValues,
           pl.allegro.webapi.service_php.FilterRelationType filterRelations) {
     ...
     * @return filterValues
     */
    public pl.allegro.webapi.service_php.FilterValueType[] getFilterValues() {
        return filterValues;
    }
     ...
     * @param filterValues
     */
    public void setFilterValues(pl.allegro.webapi.service_php.FilterValueType[] filterValues) {
        this.filterValues = filterValues;
    }
     ...
     */
    public pl.allegro.webapi.service_php.FilterRelationType getFilterRelations() {
        return filterRelations;
    }
     ...
     */
    public void setFilterRelations(pl.allegro.webapi.service_php.FilterRelationType filterRelations) {
        this.filterRelations = filterRelations;
    }
