...
public class DoGetServiceInfoCategoriesResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.ServiceInfoCatStruct[] serviceInfoCatsList;

    public DoGetServiceInfoCategoriesResponse() {
    }

    public DoGetServiceInfoCategoriesResponse(
           pl.allegro.webapi.service_php.ServiceInfoCatStruct[] serviceInfoCatsList) {
     ...
     */
    public pl.allegro.webapi.service_php.ServiceInfoCatStruct[] getServiceInfoCatsList() {
        return serviceInfoCatsList;
    }
     ...
     */
    public void setServiceInfoCatsList(pl.allegro.webapi.service_php.ServiceInfoCatStruct[] serviceInfoCatsList) {
        this.serviceInfoCatsList = serviceInfoCatsList;
    }
