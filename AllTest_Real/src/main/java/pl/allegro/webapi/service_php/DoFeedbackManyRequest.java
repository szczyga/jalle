...
public class DoFeedbackManyRequest  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.FeedbackManyStruct[] feedbacksList;
    ...
    public DoFeedbackManyRequest(
           ...
           pl.allegro.webapi.service_php.FeedbackManyStruct[] feedbacksList) {
     ...
     */
    public pl.allegro.webapi.service_php.FeedbackManyStruct[] getFeedbacksList() {
        return feedbacksList;
    }
     ...
     * @param feedbacksList
     */
    public void setFeedbacksList(pl.allegro.webapi.service_php.FeedbackManyStruct[] feedbacksList) {
        this.feedbacksList = feedbacksList;
    }
