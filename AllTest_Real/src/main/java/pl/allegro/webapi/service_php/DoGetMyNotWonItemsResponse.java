...
public class DoGetMyNotWonItemsResponse  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.NotWonItemStruct[] notWonItemsList;
    ...
    public DoGetMyNotWonItemsResponse(
           ...
           pl.allegro.webapi.service_php.NotWonItemStruct[] notWonItemsList) {
     ...
     */
    public pl.allegro.webapi.service_php.NotWonItemStruct[] getNotWonItemsList() {
        return notWonItemsList;
    }
     ...
     */
    public void setNotWonItemsList(pl.allegro.webapi.service_php.NotWonItemStruct[] notWonItemsList) {
        this.notWonItemsList = notWonItemsList;
    }
