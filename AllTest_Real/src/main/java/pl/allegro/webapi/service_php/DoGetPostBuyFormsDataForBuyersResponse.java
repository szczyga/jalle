...
public class DoGetPostBuyFormsDataForBuyersResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.PostBuyFormForBuyersDataStruct[] postBuyFormDataForBuyers;

    public DoGetPostBuyFormsDataForBuyersResponse() {
    }

    public DoGetPostBuyFormsDataForBuyersResponse(
           pl.allegro.webapi.service_php.PostBuyFormForBuyersDataStruct[] postBuyFormDataForBuyers) {
     ...
     */
    public pl.allegro.webapi.service_php.PostBuyFormForBuyersDataStruct[] getPostBuyFormDataForBuyers() {
        return postBuyFormDataForBuyers;
    }
     ...
     */
    public void setPostBuyFormDataForBuyers(pl.allegro.webapi.service_php.PostBuyFormForBuyersDataStruct[] postBuyFormDataForBuyers) {
        this.postBuyFormDataForBuyers = postBuyFormDataForBuyers;
    }
