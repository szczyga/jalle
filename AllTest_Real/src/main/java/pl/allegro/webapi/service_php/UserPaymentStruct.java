...
public class UserPaymentStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.PaymentSellersStruct[] payTransSellers;
    ...
    public UserPaymentStruct(
           long payTransId,
           pl.allegro.webapi.service_php.PaymentSellersStruct[] payTransSellers,
     ...
     */
    public pl.allegro.webapi.service_php.PaymentSellersStruct[] getPayTransSellers() {
        return payTransSellers;
    }
     ...
     */
    public void setPayTransSellers(pl.allegro.webapi.service_php.PaymentSellersStruct[] payTransSellers) {
        this.payTransSellers = payTransSellers;
    }
