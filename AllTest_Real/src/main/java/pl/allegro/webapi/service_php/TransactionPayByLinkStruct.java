...
public class TransactionPayByLinkStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.ActionDataStruct[] actionData;
    ...
    public TransactionPayByLinkStruct(
           ...
           pl.allegro.webapi.service_php.ActionDataStruct[] actionData) {
     ...
     * @return actionData
     */
    public pl.allegro.webapi.service_php.ActionDataStruct[] getActionData() {
        return actionData;
    }
     ...
     * @param actionData
     */
    public void setActionData(pl.allegro.webapi.service_php.ActionDataStruct[] actionData) {
        this.actionData = actionData;
    }
