...
public class DoGetPaymentMethodsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.PaymentMethodStruct[] paymentMethods;

    public DoGetPaymentMethodsResponse() {
    }

    public DoGetPaymentMethodsResponse(
           pl.allegro.webapi.service_php.PaymentMethodStruct[] paymentMethods) {
     ...
     */
    public pl.allegro.webapi.service_php.PaymentMethodStruct[] getPaymentMethods() {
        return paymentMethods;
    }
     ...
     */
    public void setPaymentMethods(pl.allegro.webapi.service_php.PaymentMethodStruct[] paymentMethods) {
        this.paymentMethods = paymentMethods;
    }
