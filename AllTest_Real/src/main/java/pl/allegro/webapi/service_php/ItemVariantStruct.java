...
public class ItemVariantStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.ItemVariantAttributeStruct[] attributes;
    ...
    public ItemVariantStruct(
           java.lang.String id,
           int quantity,
           pl.allegro.webapi.service_php.ItemVariantAttributeStruct[] attributes) {
           this.id = id;
     ...
     * @return attributes
     */
    public pl.allegro.webapi.service_php.ItemVariantAttributeStruct[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(pl.allegro.webapi.service_php.ItemVariantAttributeStruct[] attributes) {
        this.attributes = attributes;
    }
