...
public class DoGetItemTemplatesResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.ItemTemplatesStruct itemTemplates;

    public DoGetItemTemplatesResponse() {
    }

    public DoGetItemTemplatesResponse(
           pl.allegro.webapi.service_php.ItemTemplatesStruct itemTemplates) {
     ...
     */
    public pl.allegro.webapi.service_php.ItemTemplatesStruct getItemTemplates() {
        return itemTemplates;
    }
     ...
     * @param itemTemplates
     */
    public void setItemTemplates(pl.allegro.webapi.service_php.ItemTemplatesStruct itemTemplates) {
        this.itemTemplates = itemTemplates;
    }
