...
public class PaymentSellersStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.PaymentItemsStruct[] payTransItems;
    ...
    public PaymentSellersStruct(
           ...
           pl.allegro.webapi.service_php.PaymentItemsStruct[] payTransItems,
     ...
     */
    public pl.allegro.webapi.service_php.PaymentItemsStruct[] getPayTransItems() {
        return payTransItems;
    }
     ...
     * @param payTransItems
     */
    public void setPayTransItems(pl.allegro.webapi.service_php.PaymentItemsStruct[] payTransItems) {
        this.payTransItems = payTransItems;
    }
