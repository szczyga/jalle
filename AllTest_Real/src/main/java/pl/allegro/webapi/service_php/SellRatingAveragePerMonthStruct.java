...
public class SellRatingAveragePerMonthStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.SellRatingStatsStruct[] sellRatingAverageValues;
    ...
    public SellRatingAveragePerMonthStruct(
           ...
           pl.allegro.webapi.service_php.SellRatingStatsStruct[] sellRatingAverageValues) {
     ...
     */
    public pl.allegro.webapi.service_php.SellRatingStatsStruct[] getSellRatingAverageValues() {
        return sellRatingAverageValues;
    }
     ...
     */
    public void setSellRatingAverageValues(pl.allegro.webapi.service_php.SellRatingStatsStruct[] sellRatingAverageValues) {
        this.sellRatingAverageValues = sellRatingAverageValues;
    }
