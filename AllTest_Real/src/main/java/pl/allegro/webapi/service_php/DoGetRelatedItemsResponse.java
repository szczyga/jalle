...
public class DoGetRelatedItemsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.RelatedItemsStruct relatedItems;

    public DoGetRelatedItemsResponse() {
    }

    public DoGetRelatedItemsResponse(
           pl.allegro.webapi.service_php.RelatedItemsStruct relatedItems) {
     ...
     * @return relatedItems
     */
    public pl.allegro.webapi.service_php.RelatedItemsStruct getRelatedItems() {
        return relatedItems;
    }
     ...
     * @param relatedItems
     */
    public void setRelatedItems(pl.allegro.webapi.service_php.RelatedItemsStruct relatedItems) {
        this.relatedItems = relatedItems;
    }
