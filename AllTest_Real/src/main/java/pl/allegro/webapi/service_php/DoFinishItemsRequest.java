...
public class DoFinishItemsRequest  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.FinishItemsStruct[] finishItemsList;
    ...
    public DoFinishItemsRequest(
           ...
           pl.allegro.webapi.service_php.FinishItemsStruct[] finishItemsList) {
     ...
     */
    public pl.allegro.webapi.service_php.FinishItemsStruct[] getFinishItemsList() {
        return finishItemsList;
    }
     ...
     */
    public void setFinishItemsList(pl.allegro.webapi.service_php.FinishItemsStruct[] finishItemsList) {
        this.finishItemsList = finishItemsList;
    }
