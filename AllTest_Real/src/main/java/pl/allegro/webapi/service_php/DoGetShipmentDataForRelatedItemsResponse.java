...
public class DoGetShipmentDataForRelatedItemsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.RelatedItemsShipmentDataStruct relatedItemsShipmentData;

    public DoGetShipmentDataForRelatedItemsResponse() {
    }

    public DoGetShipmentDataForRelatedItemsResponse(
           pl.allegro.webapi.service_php.RelatedItemsShipmentDataStruct relatedItemsShipmentData) {
     ...
     */
    public pl.allegro.webapi.service_php.RelatedItemsShipmentDataStruct getRelatedItemsShipmentData() {
        return relatedItemsShipmentData;
    }
     ...
     */
    public void setRelatedItemsShipmentData(pl.allegro.webapi.service_php.RelatedItemsShipmentDataStruct relatedItemsShipmentData) {
        this.relatedItemsShipmentData = relatedItemsShipmentData;
    }
