...
public class DoGetMyPaymentsRefundsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.UserPaymentRefundsStruct[] payTransPaymentRefunds;

    public DoGetMyPaymentsRefundsResponse() {
    }

    public DoGetMyPaymentsRefundsResponse(
           pl.allegro.webapi.service_php.UserPaymentRefundsStruct[] payTransPaymentRefunds) {
     ...
     */
    public pl.allegro.webapi.service_php.UserPaymentRefundsStruct[] getPayTransPaymentRefunds() {
        return payTransPaymentRefunds;
    }
     ...
     */
    public void setPayTransPaymentRefunds(pl.allegro.webapi.service_php.UserPaymentRefundsStruct[] payTransPaymentRefunds) {
        this.payTransPaymentRefunds = payTransPaymentRefunds;
    }
