...
public class DoGetMyIncomingPaymentsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.UserIncomingPaymentStruct[] payTransIncome;

    public DoGetMyIncomingPaymentsResponse() {
    }

    public DoGetMyIncomingPaymentsResponse(
           pl.allegro.webapi.service_php.UserIncomingPaymentStruct[] payTransIncome) {
     ...
     */
    public pl.allegro.webapi.service_php.UserIncomingPaymentStruct[] getPayTransIncome() {
        return payTransIncome;
    }
     ...
     */
    public void setPayTransIncome(pl.allegro.webapi.service_php.UserIncomingPaymentStruct[] payTransIncome) {
        this.payTransIncome = payTransIncome;
    }
