...
public class DoGetPostBuyItemInfoResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.PostBuyItemInfoStruct[] itemPostBuyFormInfo;

    public DoGetPostBuyItemInfoResponse() {
    }

    public DoGetPostBuyItemInfoResponse(
           pl.allegro.webapi.service_php.PostBuyItemInfoStruct[] itemPostBuyFormInfo) {
     ...
     */
    public pl.allegro.webapi.service_php.PostBuyItemInfoStruct[] getItemPostBuyFormInfo() {
        return itemPostBuyFormInfo;
    }
     ...
     */
    public void setItemPostBuyFormInfo(pl.allegro.webapi.service_php.PostBuyItemInfoStruct[] itemPostBuyFormInfo) {
        this.itemPostBuyFormInfo = itemPostBuyFormInfo;
    }
