...
public class DoGetFavouriteSellersResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.FavouritesSellersStruct[] sFavouriteSellersList;

    public DoGetFavouriteSellersResponse() {
    }

    public DoGetFavouriteSellersResponse(
           pl.allegro.webapi.service_php.FavouritesSellersStruct[] sFavouriteSellersList) {
     ...
     */
    public pl.allegro.webapi.service_php.FavouritesSellersStruct[] getSFavouriteSellersList() {
        return sFavouriteSellersList;
    }
     ...
     */
    public void setSFavouriteSellersList(pl.allegro.webapi.service_php.FavouritesSellersStruct[] sFavouriteSellersList) {
        this.sFavouriteSellersList = sFavouriteSellersList;
    }
