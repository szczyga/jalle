...
public class DoGetPaymentDataResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.BillingDataType[] paymentList;

    public DoGetPaymentDataResponse() {
    }

    public DoGetPaymentDataResponse(
           pl.allegro.webapi.service_php.BillingDataType[] paymentList) {
     ...
     * @return paymentList
     */
    public pl.allegro.webapi.service_php.BillingDataType[] getPaymentList() {
        return paymentList;
    }
     ...
     * @param paymentList
     */
    public void setPaymentList(pl.allegro.webapi.service_php.BillingDataType[] paymentList) {
        this.paymentList = paymentList;
    }
