...
public class VariantStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.VariantQuantityStruct[] quantities;
    ...
    public VariantStruct(
           int fid,
           pl.allegro.webapi.service_php.VariantQuantityStruct[] quantities) {
           this.fid = fid;
     ...
     * @return quantities
     */
    public pl.allegro.webapi.service_php.VariantQuantityStruct[] getQuantities() {
        return quantities;
    }
     ...
     * @param quantities
     */
    public void setQuantities(pl.allegro.webapi.service_php.VariantQuantityStruct[] quantities) {
        this.quantities = quantities;
    }
