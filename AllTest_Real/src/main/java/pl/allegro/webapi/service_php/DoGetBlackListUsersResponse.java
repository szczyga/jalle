...
public class DoGetBlackListUsersResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.BlackListStruct[] blackListUsers;

    public DoGetBlackListUsersResponse() {
    }

    public DoGetBlackListUsersResponse(
           pl.allegro.webapi.service_php.BlackListStruct[] blackListUsers) {
     ...
     */
    public pl.allegro.webapi.service_php.BlackListStruct[] getBlackListUsers() {
        return blackListUsers;
    }
     ...
     */
    public void setBlackListUsers(pl.allegro.webapi.service_php.BlackListStruct[] blackListUsers) {
        this.blackListUsers = blackListUsers;
    }
