...
public class DoCreateItemTemplateResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.CreatedItemTemplateStruct createdItemTemplate;

    public DoCreateItemTemplateResponse() {
    }

    public DoCreateItemTemplateResponse(
           pl.allegro.webapi.service_php.CreatedItemTemplateStruct createdItemTemplate) {
     ...
     */
    public pl.allegro.webapi.service_php.CreatedItemTemplateStruct getCreatedItemTemplate() {
        return createdItemTemplate;
    }
     ...
     */
    public void setCreatedItemTemplate(pl.allegro.webapi.service_php.CreatedItemTemplateStruct createdItemTemplate) {
        this.createdItemTemplate = createdItemTemplate;
    }
