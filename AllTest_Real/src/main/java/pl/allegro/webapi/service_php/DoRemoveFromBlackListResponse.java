...
public class DoRemoveFromBlackListResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.BlackListResStruct[] blackListResult;

    public DoRemoveFromBlackListResponse() {
    }

    public DoRemoveFromBlackListResponse(
           pl.allegro.webapi.service_php.BlackListResStruct[] blackListResult) {
     ...
     */
    public pl.allegro.webapi.service_php.BlackListResStruct[] getBlackListResult() {
        return blackListResult;
    }
     ...
     */
    public void setBlackListResult(pl.allegro.webapi.service_php.BlackListResStruct[] blackListResult) {
        this.blackListResult = blackListResult;
    }
