...
public class DoGetItemsImagesRequest  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.ItemGetImage[] itemsArray;
    ...
    public DoGetItemsImagesRequest(
           ...
           pl.allegro.webapi.service_php.ItemGetImage[] itemsArray,
           int imageType) {
     ...
     * @return itemsArray
     */
    public pl.allegro.webapi.service_php.ItemGetImage[] getItemsArray() {
        return itemsArray;
    }
     ...
     * @param itemsArray
     */
    public void setItemsArray(pl.allegro.webapi.service_php.ItemGetImage[] itemsArray) {
        this.itemsArray = itemsArray;
    }
