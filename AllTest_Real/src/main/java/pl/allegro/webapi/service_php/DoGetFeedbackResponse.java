...
public class DoGetFeedbackResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.FeedbackList[] feedbackList;
    ...
    public DoGetFeedbackResponse(
           pl.allegro.webapi.service_php.FeedbackList[] feedbackList,
           int feedbackCount) {
     ...
     * @return feedbackList
     */
    public pl.allegro.webapi.service_php.FeedbackList[] getFeedbackList() {
        return feedbackList;
    }
     ...
     * @param feedbackList
     */
    public void setFeedbackList(pl.allegro.webapi.service_php.FeedbackList[] feedbackList) {
        this.feedbackList = feedbackList;
    }
