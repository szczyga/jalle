...
public class RelatedItemsShipmentDataStruct  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.SellerShipmentDataStruct[] sellerShipmentData;

    public RelatedItemsShipmentDataStruct() {
    }

    public RelatedItemsShipmentDataStruct(
           pl.allegro.webapi.service_php.SellerShipmentDataStruct[] sellerShipmentData) {
     ...
     */
    public pl.allegro.webapi.service_php.SellerShipmentDataStruct[] getSellerShipmentData() {
        return sellerShipmentData;
    }
     ...
     */
    public void setSellerShipmentData(pl.allegro.webapi.service_php.SellerShipmentDataStruct[] sellerShipmentData) {
        this.sellerShipmentData = sellerShipmentData;
    }
