...
public class ShipmentDataStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.ShipmentTimeStruct shipmentTime;
    ...
    public ShipmentDataStruct(
           ...
           int shipmentType,
           pl.allegro.webapi.service_php.ShipmentTimeStruct shipmentTime) {
     ...
     * @return shipmentTime
     */
    public pl.allegro.webapi.service_php.ShipmentTimeStruct getShipmentTime() {
        return shipmentTime;
    }
     ...
     * @param shipmentTime
     */
    public void setShipmentTime(pl.allegro.webapi.service_php.ShipmentTimeStruct shipmentTime) {
        this.shipmentTime = shipmentTime;
    }
