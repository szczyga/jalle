...
public class DoSendPostBuyFormResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.PostBuyFormStruct postBuyForm;

    public DoSendPostBuyFormResponse() {
    }

    public DoSendPostBuyFormResponse(
           pl.allegro.webapi.service_php.PostBuyFormStruct postBuyForm) {
     ...
     * @return postBuyForm
     */
    public pl.allegro.webapi.service_php.PostBuyFormStruct getPostBuyForm() {
        return postBuyForm;
    }
     ...
     * @param postBuyForm
     */
    public void setPostBuyForm(pl.allegro.webapi.service_php.PostBuyFormStruct postBuyForm) {
        this.postBuyForm = postBuyForm;
    }
