...
public class DoGetMyPaymentsInfoResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.PaymentsInfoStruct paymentsInfo;

    public DoGetMyPaymentsInfoResponse() {
    }

    public DoGetMyPaymentsInfoResponse(
           pl.allegro.webapi.service_php.PaymentsInfoStruct paymentsInfo) {
     ...
     * @return paymentsInfo
     */
    public pl.allegro.webapi.service_php.PaymentsInfoStruct getPaymentsInfo() {
        return paymentsInfo;
    }
     ...
     * @param paymentsInfo
     */
    public void setPaymentsInfo(pl.allegro.webapi.service_php.PaymentsInfoStruct paymentsInfo) {
        this.paymentsInfo = paymentsInfo;
    }
