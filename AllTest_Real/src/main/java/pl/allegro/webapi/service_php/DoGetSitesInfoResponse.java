...
public class DoGetSitesInfoResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.SiteInfoType[] sitesInfoList;
    ...
    public DoGetSitesInfoResponse(
           pl.allegro.webapi.service_php.SiteInfoType[] sitesInfoList,
           long verKey,
     ...
     */
    public pl.allegro.webapi.service_php.SiteInfoType[] getSitesInfoList() {
        return sitesInfoList;
    }
     ...
     * @param sitesInfoList
     */
    public void setSitesInfoList(pl.allegro.webapi.service_php.SiteInfoType[] sitesInfoList) {
        this.sitesInfoList = sitesInfoList;
    }
