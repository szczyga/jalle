...
public class DoAddPackageInfoToPostBuyFormRequest  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.PackageInfoStruct[] packageInfo;
    ...
    public DoAddPackageInfoToPostBuyFormRequest(
           ...
           long transactionId,
           pl.allegro.webapi.service_php.PackageInfoStruct[] packageInfo) {
     ...
     * @return packageInfo
     */
    public pl.allegro.webapi.service_php.PackageInfoStruct[] getPackageInfo() {
        return packageInfo;
    }
     ...
     * @param packageInfo
     */
    public void setPackageInfo(pl.allegro.webapi.service_php.PackageInfoStruct[] packageInfo) {
        this.packageInfo = packageInfo;
    }
