...
public class DoGetRefundsReasonsResponse  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.ReasonInfoType[] reasonsList;
    ...
    public DoGetRefundsReasonsResponse(
           int reasonsCount,
           pl.allegro.webapi.service_php.ReasonInfoType[] reasonsList) {
     ...
     * @return reasonsList
     */
    public pl.allegro.webapi.service_php.ReasonInfoType[] getReasonsList() {
        return reasonsList;
    }
     ...
     * @param reasonsList
     */
    public void setReasonsList(pl.allegro.webapi.service_php.ReasonInfoType[] reasonsList) {
        this.reasonsList = reasonsList;
    }
