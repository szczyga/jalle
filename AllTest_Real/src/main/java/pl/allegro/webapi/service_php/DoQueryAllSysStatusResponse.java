...
public class DoQueryAllSysStatusResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.SysStatusType[] sysCountryStatus;

    public DoQueryAllSysStatusResponse() {
    }

    public DoQueryAllSysStatusResponse(
           pl.allegro.webapi.service_php.SysStatusType[] sysCountryStatus) {
     ...
     */
    public pl.allegro.webapi.service_php.SysStatusType[] getSysCountryStatus() {
        return sysCountryStatus;
    }
     ...
     */
    public void setSysCountryStatus(pl.allegro.webapi.service_php.SysStatusType[] sysCountryStatus) {
        this.sysCountryStatus = sysCountryStatus;
    }
