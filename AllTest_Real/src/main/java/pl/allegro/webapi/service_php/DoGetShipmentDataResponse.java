...
public class DoGetShipmentDataResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.ShipmentDataStruct[] shipmentDataList;
    ...
    public DoGetShipmentDataResponse(
           pl.allegro.webapi.service_php.ShipmentDataStruct[] shipmentDataList,
           long localVersion) {
     ...
     */
    public pl.allegro.webapi.service_php.ShipmentDataStruct[] getShipmentDataList() {
        return shipmentDataList;
    }
     ...
     */
    public void setShipmentDataList(pl.allegro.webapi.service_php.ShipmentDataStruct[] shipmentDataList) {
        this.shipmentDataList = shipmentDataList;
    }
