...
public class DoGetSellFormFieldsForCategoryResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.SellFormFieldsForCategoryStruct sellFormFieldsForCategory;

    public DoGetSellFormFieldsForCategoryResponse() {
    }

    public DoGetSellFormFieldsForCategoryResponse(
           pl.allegro.webapi.service_php.SellFormFieldsForCategoryStruct sellFormFieldsForCategory) {
     ...
     */
    public pl.allegro.webapi.service_php.SellFormFieldsForCategoryStruct getSellFormFieldsForCategory() {
        return sellFormFieldsForCategory;
    }
     ...
     */
    public void setSellFormFieldsForCategory(pl.allegro.webapi.service_php.SellFormFieldsForCategoryStruct sellFormFieldsForCategory) {
        this.sellFormFieldsForCategory = sellFormFieldsForCategory;
    }
