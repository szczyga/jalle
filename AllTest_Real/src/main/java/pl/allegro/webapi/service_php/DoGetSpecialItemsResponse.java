...
public class DoGetSpecialItemsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.SpecialAuctionStruct[] sSpecialList;

    public DoGetSpecialItemsResponse() {
    }

    public DoGetSpecialItemsResponse(
           pl.allegro.webapi.service_php.SpecialAuctionStruct[] sSpecialList) {
     ...
     * @return sSpecialList
     */
    public pl.allegro.webapi.service_php.SpecialAuctionStruct[] getSSpecialList() {
        return sSpecialList;
    }
     ...
     * @param sSpecialList
     */
    public void setSSpecialList(pl.allegro.webapi.service_php.SpecialAuctionStruct[] sSpecialList) {
        this.sSpecialList = sSpecialList;
    }
