...
public class DoRemoveFromWatchListResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.ItemRemoveWatchStruct[] watchListResult;

    public DoRemoveFromWatchListResponse() {
    }

    public DoRemoveFromWatchListResponse(
           pl.allegro.webapi.service_php.ItemRemoveWatchStruct[] watchListResult) {
     ...
     */
    public pl.allegro.webapi.service_php.ItemRemoveWatchStruct[] getWatchListResult() {
        return watchListResult;
    }
     ...
     */
    public void setWatchListResult(pl.allegro.webapi.service_php.ItemRemoveWatchStruct[] watchListResult) {
        this.watchListResult = watchListResult;
    }
