...
public class WatchListInfoStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.ItemsNotAddedStruct[] itemsNotAdded;
    ...
    public WatchListInfoStruct(
           long[] itemsAdded,
           pl.allegro.webapi.service_php.ItemsNotAddedStruct[] itemsNotAdded) {
     ...
     */
    public pl.allegro.webapi.service_php.ItemsNotAddedStruct[] getItemsNotAdded() {
        return itemsNotAdded;
    }
     ...
     * @param itemsNotAdded
     */
    public void setItemsNotAdded(pl.allegro.webapi.service_php.ItemsNotAddedStruct[] itemsNotAdded) {
        this.itemsNotAdded = itemsNotAdded;
    }
