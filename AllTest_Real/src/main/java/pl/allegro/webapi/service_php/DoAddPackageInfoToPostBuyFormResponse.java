...
public class DoAddPackageInfoToPostBuyFormResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.PostBuyFormPackageInfoStruct postBuyFormPackageInfo;

    public DoAddPackageInfoToPostBuyFormResponse() {
    }

    public DoAddPackageInfoToPostBuyFormResponse(
           pl.allegro.webapi.service_php.PostBuyFormPackageInfoStruct postBuyFormPackageInfo) {
     ...
     */
    public pl.allegro.webapi.service_php.PostBuyFormPackageInfoStruct getPostBuyFormPackageInfo() {
        return postBuyFormPackageInfo;
    }
     ...
     */
    public void setPostBuyFormPackageInfo(pl.allegro.webapi.service_php.PostBuyFormPackageInfoStruct postBuyFormPackageInfo) {
        this.postBuyFormPackageInfo = postBuyFormPackageInfo;
    }
