...
public class DoGetStatesInfoResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.StateInfoStruct[] statesInfoArray;

    public DoGetStatesInfoResponse() {
    }

    public DoGetStatesInfoResponse(
           pl.allegro.webapi.service_php.StateInfoStruct[] statesInfoArray) {
     ...
     */
    public pl.allegro.webapi.service_php.StateInfoStruct[] getStatesInfoArray() {
        return statesInfoArray;
    }
     ...
     */
    public void setStatesInfoArray(pl.allegro.webapi.service_php.StateInfoStruct[] statesInfoArray) {
        this.statesInfoArray = statesInfoArray;
    }
