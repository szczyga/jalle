...
public class DoGetPostBuyDataResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.ItemPostBuyDataStruct[] itemsPostBuyData;

    public DoGetPostBuyDataResponse() {
    }

    public DoGetPostBuyDataResponse(
           pl.allegro.webapi.service_php.ItemPostBuyDataStruct[] itemsPostBuyData) {
     ...
     */
    public pl.allegro.webapi.service_php.ItemPostBuyDataStruct[] getItemsPostBuyData() {
        return itemsPostBuyData;
    }
     ...
     */
    public void setItemsPostBuyData(pl.allegro.webapi.service_php.ItemPostBuyDataStruct[] itemsPostBuyData) {
        this.itemsPostBuyData = itemsPostBuyData;
    }
