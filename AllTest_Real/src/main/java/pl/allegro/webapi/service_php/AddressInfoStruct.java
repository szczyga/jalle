...
public class AddressInfoStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.AddressUserDataStruct addressUserData;
    ...
    public AddressInfoStruct(
           int addressType,
           pl.allegro.webapi.service_php.AddressUserDataStruct addressUserData) {
     ...
     */
    public pl.allegro.webapi.service_php.AddressUserDataStruct getAddressUserData() {
        return addressUserData;
    }
     ...
     */
    public void setAddressUserData(pl.allegro.webapi.service_php.AddressUserDataStruct addressUserData) {
        this.addressUserData = addressUserData;
    }
