...
public class DoChangeItemFieldsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.ChangedItemStruct changedItem;

    public DoChangeItemFieldsResponse() {
    }

    public DoChangeItemFieldsResponse(
           pl.allegro.webapi.service_php.ChangedItemStruct changedItem) {
     ...
     * @return changedItem
     */
    public pl.allegro.webapi.service_php.ChangedItemStruct getChangedItem() {
        return changedItem;
    }
     ...
     * @param changedItem
     */
    public void setChangedItem(pl.allegro.webapi.service_php.ChangedItemStruct changedItem) {
        this.changedItem = changedItem;
    }
