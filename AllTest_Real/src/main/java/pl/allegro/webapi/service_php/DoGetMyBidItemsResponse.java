...
public class DoGetMyBidItemsResponse  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.BidItemStruct[] bidItemsList;
    ...
    public DoGetMyBidItemsResponse(
           int bidItemsCounter,
           pl.allegro.webapi.service_php.BidItemStruct[] bidItemsList) {
     ...
     * @return bidItemsList
     */
    public pl.allegro.webapi.service_php.BidItemStruct[] getBidItemsList() {
        return bidItemsList;
    }
     ...
     * @param bidItemsList
     */
    public void setBidItemsList(pl.allegro.webapi.service_php.BidItemStruct[] bidItemsList) {
        this.bidItemsList = bidItemsList;
    }
