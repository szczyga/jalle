...
public class DoMyFeedback2Response  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.MyFeedbackListStruct2[] myfeedbackList;

    public DoMyFeedback2Response() {
    }

    public DoMyFeedback2Response(
           pl.allegro.webapi.service_php.MyFeedbackListStruct2[] myfeedbackList) {
     ...
     */
    public pl.allegro.webapi.service_php.MyFeedbackListStruct2[] getMyfeedbackList() {
        return myfeedbackList;
    }
     ...
     */
    public void setMyfeedbackList(pl.allegro.webapi.service_php.MyFeedbackListStruct2[] myfeedbackList) {
        this.myfeedbackList = myfeedbackList;
    }
