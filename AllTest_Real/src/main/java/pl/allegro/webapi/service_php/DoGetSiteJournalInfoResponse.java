...
public class DoGetSiteJournalInfoResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.SiteJournalInfo siteJournalInfo;

    public DoGetSiteJournalInfoResponse() {
    }

    public DoGetSiteJournalInfoResponse(
           pl.allegro.webapi.service_php.SiteJournalInfo siteJournalInfo) {
     ...
     */
    public pl.allegro.webapi.service_php.SiteJournalInfo getSiteJournalInfo() {
        return siteJournalInfo;
    }
     ...
     */
    public void setSiteJournalInfo(pl.allegro.webapi.service_php.SiteJournalInfo siteJournalInfo) {
        this.siteJournalInfo = siteJournalInfo;
    }
