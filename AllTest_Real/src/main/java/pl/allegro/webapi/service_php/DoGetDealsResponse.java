...
public class DoGetDealsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.DealsStruct[] dealsList;

    public DoGetDealsResponse() {
    }

    public DoGetDealsResponse(
           pl.allegro.webapi.service_php.DealsStruct[] dealsList) {
     ...
     * @return dealsList
     */
    public pl.allegro.webapi.service_php.DealsStruct[] getDealsList() {
        return dealsList;
    }
     ...
     * @param dealsList
     */
    public void setDealsList(pl.allegro.webapi.service_php.DealsStruct[] dealsList) {
        this.dealsList = dealsList;
    }
