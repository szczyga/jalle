...
public class DoGetFilledPostBuyFormsResponse  implements java.io.Serializable {
    private pl.allegro.webapi.service_php.FilledPostBuyFormsStruct filledPostBuyForms;

    public DoGetFilledPostBuyFormsResponse() {
    }

    public DoGetFilledPostBuyFormsResponse(
           pl.allegro.webapi.service_php.FilledPostBuyFormsStruct filledPostBuyForms) {
     ...
     */
    public pl.allegro.webapi.service_php.FilledPostBuyFormsStruct getFilledPostBuyForms() {
        return filledPostBuyForms;
    }
     ...
     */
    public void setFilledPostBuyForms(pl.allegro.webapi.service_php.FilledPostBuyFormsStruct filledPostBuyForms) {
        this.filledPostBuyForms = filledPostBuyForms;
    }
