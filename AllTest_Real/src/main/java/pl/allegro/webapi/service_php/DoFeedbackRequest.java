...
public class DoFeedbackRequest  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.SellRatingEstimationStruct[] feRating;
    ...
    public DoFeedbackRequest(
           ...
           int feOp,
           pl.allegro.webapi.service_php.SellRatingEstimationStruct[] feRating) {
     ...
     * @return feRating
     */
    public pl.allegro.webapi.service_php.SellRatingEstimationStruct[] getFeRating() {
        return feRating;
    }
     ...
     * @param feRating
     */
    public void setFeRating(pl.allegro.webapi.service_php.SellRatingEstimationStruct[] feRating) {
        this.feRating = feRating;
    }
