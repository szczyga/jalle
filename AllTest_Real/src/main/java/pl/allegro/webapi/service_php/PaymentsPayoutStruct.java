...
public class PaymentsPayoutStruct  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.PayoutAutoSettingsStruct payoutAutoSettings;
    ...
    public PaymentsPayoutStruct(
           int payoutType,
           pl.allegro.webapi.service_php.PayoutAutoSettingsStruct payoutAutoSettings) {
     ...
     */
    public pl.allegro.webapi.service_php.PayoutAutoSettingsStruct getPayoutAutoSettings() {
        return payoutAutoSettings;
    }
     ...
     */
    public void setPayoutAutoSettings(pl.allegro.webapi.service_php.PayoutAutoSettingsStruct payoutAutoSettings) {
        this.payoutAutoSettings = payoutAutoSettings;
    }
